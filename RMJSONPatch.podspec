...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   JSONPatch is a swift library for applying and generating RFC-6902 compliant JSON patches.
  ...
  # Or just: s.author    = "Raymond McCrae"
  # s.authors            = { "Raymond McCrae" => "raymccrae@yahoo.com" }
  s.social_media_url   = "http://twitter.com/raymccrae"
  ...
  s.source       = { :git => "https://github.com/rjga94/swift-jsonpatch.git", :tag => "v#{s.version}" }
  ...
  s.source_files  = "JSONPatch", "Sources/**/*.{h,swift}"
